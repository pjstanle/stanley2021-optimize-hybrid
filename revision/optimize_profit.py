...
def profit_objective(turbine_x, turbine_y, target_solar_capacity, battery_capacity):
    global hybrid_plant
    ...
    ppa = 70.0
    annual_profit = yearly_energy * ppa - yearly_cost
...
def objective_function(inputs):
    ...
    objective = profit_objective(turbine_x, turbine_y, target_solar_capacity, battery_capacity)
