...
if __name__=="__main__":
    ...
    nopts = 4
    wind_speed_multipliers = [0.6,0.8,1.0,1.2,1.4]

    for h in range(len(wind_speed_multipliers)):
        best_answer = 1E20
        for P in range(nopts):
            ...
            wind_speed_multiplier = wind_speed_multipliers[h]
            ...
            if function_value < best_answer:
                ...
                print("WIND SPEED MULTIPLIER: ", wind_speed_multiplier)
