...
if __name__=="__main__":
    ...
    bounds = np.array([(min_turbine_spacing,8*min_turbine_spacing),(min_turbine_spacing,8*min_turbine_spacing),
                        (0,np.pi/4),(-np.pi,np.pi),(0.4*corner,0.6*corner),(0.4*corner,0.6*corner),
                        (0.0,1.0),(0.0,1.0)])
    
    bits = np.array([8,8,8,8,8,8,1,1])
