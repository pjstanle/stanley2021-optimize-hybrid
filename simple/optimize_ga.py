...
def union_solar(solar_x,solar_y):
    ...
    try:
        ...
        areas = np.array([panel_union.area])
        return 1, areas
...
if __name__=="__main__":
    ...
    DVopt = np.array([1., 0., 2., 2., 2., 2., 2., 2., 0., 0., 0., 0., 2., 2., 0., 2., 2., 2., 0., 1., 2., 2., 2., 2.,
             2., 2., 2., 2., 0., 0., 2., 2., 2., 2., 2., 2., 2., 2., 2., 2., 0., 2., 2., 2., 2., 2., 2., 2.,
             2., 2., 2., 2., 2., 2., 2., 2., 0., 2., 2., 2., 0., 0., 2., 2., 2., 2., 2., 0., 0., 0., 1., 0.,
             2., 2., 2., 2., 2., 0., 1., 0., 0., 0., 2., 2., 2., 2., 2., 0., 0., 0., 2., 2., 2., 2., 0., 2.,
             2., 2., 2., 2.])
    tx, ty, sx, sy = create_farm(DVopt)
