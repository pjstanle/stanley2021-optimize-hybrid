...
if __name__=="__main__":
    ...
    absolute_min_energy = 0.0 # farm must produce at least this amount at all times
    ...
    outage_start = 3000
    outage_duration = 12
    HOPP_plant = init_wind_plant(hub_height,rotor_diameter,powercurve_filename,outage_start=outage_start,outage_duration=outage_duration,wind_speed_multiplier=wsm)
